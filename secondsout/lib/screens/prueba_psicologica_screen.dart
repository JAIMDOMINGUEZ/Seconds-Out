...
import 'package:secondsout/data/models/prueba_psicologica.dart';

class PruebaPsicologicaScreen extends StatefulWidget {
  final PruebaPsicologica? pruebaExistente;
  final Function(PruebaPsicologica) onGuardar;

  const PruebaPsicologicaScreen({
    super.key,
  ...
  @override
  State<PruebaPsicologicaScreen> createState() => _PruebaPsicologicaScreenState();
}

class _PruebaPsicologicaScreenState extends State<PruebaPsicologicaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Prueba Psicológica'),
        centerTitle: true,
      ),
