...
class EditarPruebaReglasScreen extends StatefulWidget {
  final PruebaReglas? pruebaExistente;
  final Function(PruebaReglas) onGuardar;

  const EditarPruebaReglasScreen({
    super.key,
  ...
  @override
  State<EditarPruebaReglasScreen> createState() => _EditarPruebaReglasScreenState();
}

class _EditarPruebaReglasScreenState extends State<EditarPruebaReglasScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Editar Prueba de Reglas'),
        centerTitle: true,
      ),
